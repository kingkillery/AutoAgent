...
from autoagent.util import get_openai_assistant_agent
...
async def test_openai_assistant():
    """Test the OpenAI Assistant Agent."""
    console = Console()
    console.print("[bold green]Testing OpenAI Assistant Agent...[/bold green]")
    
    # Create the OpenAI Assistant Agent
    agent, openai_tools, instructions = get_openai_assistant_agent(
        name="Test Assistant",
    ...
    console.print("[bold blue]Initializing OpenAI Assistant...[/bold blue]")
    await agent.initialize(tools=openai_tools, instructions=instructions)
...
if __name__ == "__main__":
    asyncio.run(test_openai_assistant()) 